...
export default function Home() {
  ...
  const api = "http://185.245.182.159/api";
    ...
    <main>
      ...
      <section className={styles.vacation_offers_block}>
        <Container>
          ...
          <OffersBlock offerTitle="Популярные отели" slides={hotelOffers} />
        </Container>
      </section>
        ...
        <Container>
          <div className={styles.car_block_inner}>
            ...
            <div className={styles.car_desc_block}>
              ...
              <h4 className={styles.car_block_title}>Аренда Автомобиля</h4>
              <ul className={styles.desc_list}>
                <li className={styles.desc_list_item}>
                  обеспечить свободу передвижения и гибкость в планировании
                  маршрута путешествия.
                </li>
                <li className={styles.desc_list_item}>
                  дает возможность избежать неудобств общественного транспорта,
                  в том числе перенапряжения и ожиданий.
                </li>
                <li className={styles.desc_list_item}>
                  позволяет путешествовать в максимально комфортных условиях
                </li>
                <li className={styles.desc_list_item}>
                  более экономически выгодно, чем использование такси
                </li>
              </ul>

              <PageLink linkTo="/transfer" text="Перейти" />
            </div>
          </div>
        </Container>
      </section>
      ...
      <section className={styles.comments_block}>
        <Container>
          <div className={styles.comments_block_swiper}>
            <h2 className={styles.offer_title}>Отзывы</h2>
            <Swiper
              modules={[Navigation]}
              spaceBetween={30}
              breakpoints={{
